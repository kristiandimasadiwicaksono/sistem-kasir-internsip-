...
<h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Tambah Supplier Baru</h1>
    ...
    <form id="supplier-form" action="{{ route('suppliers.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" id="nama" name="nama" required class="py-3 px-4 block w-full border border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
        </div>

        <!-- Contact Person -->
        <div>
            <label for="kontak" class="block text-sm font-medium text-gray-700 mb-2">Kontak</label>
            <input type="text" id="kontak" name="kontak" required class="py-3 px-4 block w-full border border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
        </div>
